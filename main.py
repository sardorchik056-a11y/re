...
WELCOME_TEXT = "<b>Добро пожаловать, стрелок.\n</b>\n\n<b>Здесь слова имеют вес только если подкреплены звоном монет. Хочешь доказать, что ты лучший?</b> \n<b>Приготовь свой кошелек и хладнокровие!</b>"
